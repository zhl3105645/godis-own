...
func NewTransaction(cluster *Cluster, c redis.Connection, id string, cmdLine CmdLine) *Transaction {
	return &Transaction{
		id:      id,
		cmdLine: cmdLine,
		cluster: cluster,
...
// Reentrant. invoker should hold tx.mu
...
// prepare: tx should have Keys and ID field
