...
// DB stores data and execute user's command
type DB struct {
	index int
	// key -> DataEntity
	data dict.Dict
	...
	// dict.Dict makes sure concurrent-safety by using locker for complicated command, e.g. rpush, incr ..
	locker *lock.Locks
...
func (db *DB) Expire(key string, expireTime time.Time) {
	...
	timewheel.At(expireTime, taskKey, func() {
		...
		// check-lock-check, ttl may update during the wait
...
// GetVersion returns version code of given key
